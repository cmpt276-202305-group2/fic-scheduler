...
const ImportCourses = ({
    ...
    const [isCourseOfferingListVisible, setIsCourseOfferingListVisible] = useState(false);

    const handleShowCourseOfferingList = () => {
        setIsCourseOfferingListVisible(prevIsCourseOfferingListVisible => !prevIsCourseOfferingListVisible);
    }
