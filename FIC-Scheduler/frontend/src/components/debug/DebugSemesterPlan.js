          ...
          {allSemesterPlans.map((row, rowIndex) => {
            ...
            return (
              <tr key={rowIndex}>
                ...
                <td key="5">
                  <pre>{JSON.stringify(row.instructorsAvailable, null, 2)}</pre>
                </td>
                <td key="6">
                  <pre>{JSON.stringify(row.classroomsAvailable, null, 2)}</pre>
                </td>
              </tr>
            );
          })}
        ...
        onSubmit={(event) => {
          ...
          try {
            ...
            if (formCoursesOffered)
              semesterPlanObj.coursesOffered = JSON.parse(formCoursesOffered);
      ...
      >
        ...
        <table className={styles.DebugFormTable}>
          <tbody>
            ...
            <tr>
              <td>
                <label htmlFor="form-courses-offered">Courses Offered</label>
              </td>
              <td>
                <textarea
                  ...
                  onChange={(event) =>
                    setFormCoursesOffered(event.target.value)
                  }
                  placeholder="Don't update"
                  rows="10"
                  cols="50"
            ...
            <tr>
              <td>
                <label htmlFor="form-instructors-available">
            ...
            <tr>
              <td>
                <label htmlFor="form-classrooms-available">
