...
import ImportAccreditation from "../components/ImportAccreditation";


function ManageCoursePage() {
    const [coursesSpreadsheetData, setCoursesSpreadsheetData] = useState([]);
    const [accreditationSpreadsheetData, setAccreditationSpreadsheetData] = useState([]);
    return (
        <CheckAuth permittedRoles={["ADMIN", "COORDINATOR"]} fallback={<Navigate to="/" replace />}>
            <div className={styles.Container}>
                ...
                <div className={styles.PageContent} data-testid="configuration">
                    ...
                    />
                    <ImportAccreditation
                        accreditationSpreadsheetData={accreditationSpreadsheetData}
                        setAccreditationSpreadsheetData={setAccreditationSpreadsheetData}
                    />
                </div>
            </div>
        </CheckAuth>
