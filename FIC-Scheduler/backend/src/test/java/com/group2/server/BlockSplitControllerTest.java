...
import com.group2.server.model.BlockRequirement;
...
public class BlockSplitControllerTest {
    ...
    public void testReadListByQuery() throws Exception {
        ...
        mockBlockSplits.add(new BlockRequirementSplit(1, "Block 1", new ArrayList<BlockRequirement>()));
        mockBlockSplits.add(new BlockRequirementSplit(2, "Block 2", new ArrayList<BlockRequirement>()));
    ...
    public void testReadOneByIdExceptionCase() throws Exception {
        ...
        when(blockRequirementSplitRepository.findById(blockSplitId))
                .thenThrow(new RuntimeException("Block split not found"));
    ...
    public void testUpdateOneById() throws Exception {
        ...
        // Verify that blockRequirementSplitRepository.save() was called once with the
        // updated block split
    ...
    public void testUpdateOneByExceptionCase() throws Exception {
        int blockSplitId = 1;
        BlockRequirementSplitDto blockRequirementSplitDto = new BlockRequirementSplitDto(2, "Block 1", null); // ID 2
                                                                                                              // mismatches
                                                                                                              // with
                                                                                                              // blockSplitId
        ...
        // Verify that blockRequirementSplitRepository.findById() was not called because
        // of the mismatched IDs
    ...
    public void testDeleteOneById() throws Exception {
        ...
        // Verify that blockRequirementSplitRepository.deleteById() was called once with
        // the correct ID
